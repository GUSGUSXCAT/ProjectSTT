...
class DragDropG3Screen extends StatefulWidget {
  final String set;
  const DragDropG3Screen({Key? key, required this.set}) : super(key: key);

  @override
  State<DragDropG3Screen> createState() => _DragDropScreenG3State();
}

class _DragDropScreenG3State extends State<DragDropG3Screen> {
  ...
  Future<void> _fetchQuestions() async {
    try {
      ...
      for (int i = 0; i < rawQuestions.length; i++) {
        ...
        final List<String> correctList = (answers is List)
