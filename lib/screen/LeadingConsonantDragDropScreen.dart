...
class LeadingConsonantDragDropScreen extends StatefulWidget {
  final String type;
  final String set;

  const LeadingConsonantDragDropScreen({
    super.key,
    required this.type,
    required this.set,
  });
  ...
  @override
  State<LeadingConsonantDragDropScreen> createState() => _LeadingConsonantDragDropScreenState();
}

class _LeadingConsonantDragDropScreenState extends State<LeadingConsonantDragDropScreen> {
  ...
  Future<void> _saveScore(int score) async {
    try {
      ...
      await _firestore.collection('quiz_results').add({
        ...
        "category": "อักษรนำ ลากวาง (${getTypeName()} ชุดที่ ${widget.set})",
