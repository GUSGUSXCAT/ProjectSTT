...
class BlendedVowelScreen extends StatefulWidget {
  const BlendedVowelScreen({super.key});

  @override
  State<BlendedVowelScreen> createState() => _BlendedVowelScreenState();
}

class _BlendedVowelScreenState extends State<BlendedVowelScreen> {
  ...
  Future<void> saveQuizResult() async {
    try {
      ...
      await _firestore.collection('quiz_results').add({
        ...
        "category": "ฝึกอ่านหน่วยเสียงสระประสม ป.1",
  ...
  Widget build(BuildContext context) {
    ...
    if (consonants.isEmpty) {
      return Scaffold(
        appBar: AppBar(
          title: Text('ฝึกอ่านหน่วยเสียงสระประสม ป.1',
              style: GoogleFonts.mali()),
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Text('ฝึกอ่านหน่วยเสียงสระประสม ป.1',
                style: GoogleFonts.mali(fontSize: 18)),
            Text(
                  ...
                  child: IntrinsicHeight(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            '🐈⋆୨୧˚ ให้นักเรียนอ่านสระประสมที่เห็นบนจอ',
